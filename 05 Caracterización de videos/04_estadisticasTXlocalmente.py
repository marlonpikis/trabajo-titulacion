...
Graficar intervalo de confianza de videos transmitidos localmente
'''
...
plt.xticks(list(range(0, len(archivos))), [archivo[:-4].upper() for archivo in archivos], rotation=90)

plt.savefig(f'{sys.argv[1][:-8]}.png', dpi=300)
plt.show()